...
CHALLENGE07_FILEPATH = "util/challenge07data.txt"
...
def encryptAES128_ECBMode(input_bytes: bytes, key_byte: bytes) -> bytes:
    """
...
def decryptAES128_ECBMode(input_bytes: bytes, key_byte: bytes) -> bytes:
    """
...
def main():
    ...
    ciphertext_bytes = encryptAES128_ECBMode(plaintext_bytes, key_bytes)
