...
class HarderECBOracle:
    ...
    def __init__(self):
        ...
        self.random_prefix = secrets.token_bytes(random.randint(5, 10))
        print("RANDOM PREFIX")
        print(len(self.random_prefix))
        print("===")
    ...
    def encrypt(self, plaintext_bytes):
        ...
        """
        ecb_input_bytes = self.random_prefix + plaintext_bytes + self.unknown_encrypted_bytes
...
def breakOracleByteAtATimeHarder(ecb_oracle: HarderECBOracle) -> bytes:
    ...
    for i in range(2, block_size):
        ...
        if prev_prefix_guess_bytes[:block_size] == curr_prefix_guess_oracle_bytes[:block_size]:
